 ...
 */
 ...
 void list_movies_with_pricing() {
     ...
     while (temp != NULL) {
         ...
         if (has_showtimes && min_price != max_price) {
             printf("%-5d | %-30s | %-15s | %d mins  | Rs.%.2f-Rs.%.2f\n", 
                    temp->movie.id, 
                    temp->movie.name, 
                    temp->movie.genre, 
                    temp->movie.duration,
 ...
 void manage_movie_pricing(int id) {
     ...
     printf("Current base price: Rs.%.2f\n", movie->base_price);
     
     printf("Enter new base price (Rs.): ");
     float new_price;
     scanf("%f", &new_price);
     while(getchar() != '\n');
     ...
     if (new_price > 0) {
         ...
         printf("Base price updated to Rs.%.2f\n", new_price);
 ...
 void edit_showtime_price(int id) {
     ...
     if (new_price > 0) {
         ...
         printf("Showtime price updated to Rs.%.2f\n", new_price);
     } else {
         printf("Invalid price entered\n");
     }
 }
         ...
         switch(choice) {
             ...
             case 3: {
                 ...
                 while (temp != NULL) {
                     ...
                     if (movie) {
                         printf("%-5d | %-20s | %-12s | %-12s | %-8d | Rs.%-9.2f\n",
                                temp->showtime.id,
                                movie->name,
                                temp->showtime.date,
                                temp->showtime.time,
     ...
     do {
         ...
         switch(choice) {
             case 1: {
                 ...
                 printf("Enter ticket price (Rs.) [Base: Rs.%.2f]: ", movie->base_price);
             ...
             case 1: {
                 ...
                 for (int i = booking_count - 1; i >= 0 && displayed < 10; i--) {
                     ...
                     if (customer && movie && showtime) {
                         ...
                         printf("%-5d | %-15s | %-20s | %-12s | %-8s | Rs.%-9.2f\n",
                                bookings[i].id,
                                customer->name,
                                movie->name,
                                showtime->date,
